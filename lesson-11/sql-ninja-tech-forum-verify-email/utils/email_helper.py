...
def send_email(receiver_email, subject, text):
    sender_email = os.getenv("MY_SENDER_EMAIL", "egontomic75@gmail.com")  # Your website's official email address
    api_key = os.getenv('SENDGRID_API_KEY', "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")
